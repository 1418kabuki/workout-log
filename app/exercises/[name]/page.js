...
const youtubeSearches = {
    ...
    "ベントオーバーロウ": [
        { title: "ベントオーバーロウの正しいフォーム", query: "ベントオーバーロウ フォーム 解説" },
        { title: "背中の厚みを作るコツ", query: "ベントオーバーロウ 背中 厚み コツ" },
    ],
    "シーテッドロウ": [
        { title: "シーテッドロウの正しいフォーム", query: "シーテッドロウ フォーム 解説" },
        { title: "背中に効かせるポイント", query: "シーテッドロウ 背中 効かせ方" },
    ],
    "ワンアームロウ": [
        { title: "ワンアームロウの正しいフォーム", query: "ワンアームロウ フォーム 解説" },
        { title: "広背筋に効かせるコツ", query: "ワンアームロウ 広背筋 効かせ方" },
    ],
    "ショルダープレス": [
        { title: "ショルダープレスの正しいフォーム", query: "ショルダープレス フォーム 解説" },
        { title: "肩を痛めないコツ", query: "ショルダープレス 肩 痛め ない コツ" },
    ],
    "サイドレイズ": [
    ...
    "レッグプレス": [
        { title: "レッグプレスの正しいフォーム", query: "レッグプレス フォーム 解説" },
        { title: "レッグプレス 足の位置による違い", query: "レッグプレス 足幅 位置 違い" },
    ],
    "ランジ": [
